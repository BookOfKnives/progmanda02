...
let herotext = {"type":"champion","format":"standAloneComplex","version":"11.23.1",
    "data":{"Aatrox":{"version":"11.23.1","id":"Aatrox","key":"266","name":"Aatrox",
            "title":"the Darkin Blade","blurb":"Once honored defenders of Shurima against the Void, " +
                "Aatrox and his brethren would eventually become an even greater threat to Runeterra, " +
                "and were defeated only by cunning mortal sorcery. But after centuries of imprisonment, " +
                "Aatrox was the first to find...",
